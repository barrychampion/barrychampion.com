<footer class="footer" role="contentinfo">
	<div class="footer-links">
		<div class="first">
			<a href="<?= esc_url(home_url('/')); ?>" title="Barry Champion SVG cartoon face"><img src="<?= get_site_url(); ?>/dist/images/barry-champion-face.svg" width="150" height="186" alt="Barry Champion SVG face" class="svg-face"></a>
